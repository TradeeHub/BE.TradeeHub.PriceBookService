...
public class ServiceCategoryType: ObjectType<ServiceCategoryEntity>
{
    protected override void Configure(IObjectTypeDescriptor<ServiceCategoryEntity> descriptor)
    {
