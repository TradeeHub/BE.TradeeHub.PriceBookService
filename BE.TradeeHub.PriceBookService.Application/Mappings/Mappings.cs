...
//             request.AdditionalCosts?.Select(ac => ac.ToAdditionalServiceCostEntity()).ToList(), request.WarrantyIds,
//             userOwnerId, createdBy);
//     }
//
...
//             request.Price, request.ServiceIds, request.PricingTiers?.Select(pt => pt.ToPricingTierEntity()).ToList(),
//             userOwnerId, createdBy
//         );
//     }
//
...
//             request.ParentServiceCategoryId);
//     }
//
...
//     {
//         return new AdditionalServiceCostEntity(request.Name, request.Description, request.Cost, request.TaxRateType,
//             request.TaxRateId);
//     }
//
